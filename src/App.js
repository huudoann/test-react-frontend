...
function App() {
  ...
  const [activeTab, setActiveTab] = useState('list'); // 'create' or 'list'
  ...
  const handleCancel = () => {
    ...
    setActiveTab('list'); // Chuyển về tab danh sách sau khi hủy
  };
  ...
  const handleEdit = (user) => {
    ...
    setActiveTab('create'); // Chuyển sang tab tạo/chỉnh sửa
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setEditingUser(null);
      await loadUsers();
      setActiveTab('list'); // Chuyển về tab danh sách sau khi tạo/cập nhật thành công
    } catch (err) {
    ...
    <div className="App">
      <header className="App-header">
        <div className="app-container">
          <h1 className="app-title">Quản Lý Người Dùng V4.1.5678</h1>
          <p className="app-subtitle">Giao diện mới với trải nghiệm người dùng được cải thiện</p>
          <div className="version-badge">
            ✨ v4.1.568 - Enhanced UI Experience | Build: {new Date().toLocaleString('vi-VN')}
          </div>
          ...
          <div className="tab-content">
              ...
              <div className="users-list card">
                ...
                {loading && users.length === 0 ? (
                  ...
                  <div className="empty-state">
                    ...
                    <p className="empty-text">Chưa có người dùng nào. Hãy tạo người dùng mới!</p>
                    <button
            ...
            {/* Tab: Tạo/Chỉnh Sửa Người Dùng */}
            {activeTab === 'create' && (
              <div className="user-form card">
                <h2 className="form-title">
                  {editingUser ? '✏️ Chỉnh Sửa Người Dùng' : '➕ Tạo Người Dùng Mới'}
                </h2>
